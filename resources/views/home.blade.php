...
=======
                           <h1 id="itemcount" class="loader_wait">{{-- {{ (!empty($tabs)) ? $tabs[0]->id : ""  }} --}}</h1>
>>>>>>> 0b4585ee48b59885ec1952b86ec824c8c8b4ec71
                           <br>
                        </div>
                     </center>
                  </div>
...
=======
                           <h1 id="dailySales" class="loader_wait">{{-- {{ (!empty($tabs)) ? $tabs[0]->id : "" }} --}}</h1>
>>>>>>> 0b4585ee48b59885ec1952b86ec824c8c8b4ec71
                           <br>
                        </div>
                     </center>
...
=======
                           <h1 id="totalSales" class="loader_wait">{{-- {{ (!empty($tabs)) ? $tabs[0]->id : "" }} --}}</h1>
>>>>>>> 0b4585ee48b59885ec1952b86ec824c8c8b4ec71
                           <br>
                        </div>
                     </center>
