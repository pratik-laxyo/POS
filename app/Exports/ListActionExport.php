    ...
    */
    ...
    public function map($item): array
    {
        return [ 
            ...
            $item->cost_price,
            $item->hsn_no,
            $item->ItemTax[0]->percent,
            $item->ItemTax[1]->percent,
            $item->ItemTax[2]->percent,
            json_decode($item->discounts)->retail,
            json_decode($item->discounts)->wholesale,
            json_decode($item->discounts)->franchise,
            json_decode($item->discounts)->special,
            "0",
            "0",
            "0",
            "0",
